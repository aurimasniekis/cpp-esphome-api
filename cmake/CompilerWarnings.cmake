...
# esphome_api_set_warnings(<target> [PUBLIC|PRIVATE|INTERFACE])
#
# Applies a strict warning set per compiler. Adds -Werror / /WX when
# ESPHOME_API_WARNINGS_AS_ERRORS is ON.
function(esphome_api_set_warnings target)
    ...
    if(ESPHOME_API_WARNINGS_AS_ERRORS)
